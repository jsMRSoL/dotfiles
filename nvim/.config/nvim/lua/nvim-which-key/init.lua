...
vim.cmd(
  [[autocmd FileType which_key set laststatus=0 noruler | autocmd BufLeave <buffer> set laststatus=2 ruler]]
)
...
local keymap = {
  ...
  d = {
    ...
    K = {"<Cmd>lua require('dap.ui.variables').hover()<CR>", 'hover scopes'},
