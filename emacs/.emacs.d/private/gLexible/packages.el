...
(defconst gLexible-packages
  '((greek-lexicon-mode :location local))
...
(defun gLexible/init-greek-lexicon-mode ()
   "Initialize greek-lexicon-mode"
   (use-package greek-lexicon-mode
      :init
      (spacemacs/set-leader-keys-for-minor-mode 'greek-lexicon-mode
        "l" 'glex-get-lemmas
        "d" 'glex-get-defs
        "a" 'glex-send-to-list)
  ))
