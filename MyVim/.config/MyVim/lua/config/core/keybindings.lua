...
local mappings = {
  ...
  { "n", "<leader>xla", "<Cmd>lua require('lewis.latin-dictionary').get_line_entries({level = 'asvocab'})<CR>", { desc = "line alevel" } },
  -- greek
  { "n", "<leader>xgl", "<Cmd>lua require('lewis.greek-lexicon').create_layout()<CR>", { desc = "dictionary mode" } },
  { "n", "<leader>xgg", "<Cmd>lua require('lewis.greek-lexicon').get_line_entries({level = 'gcse'})<CR>", { desc = "line gcse" } },
  { "n", "<leader>xga", "<Cmd>lua require('lewis.greek-lexicon').get_line_entries({level = 'asvocab'})<CR>", { desc = "line alevel" } },
  -- yank
